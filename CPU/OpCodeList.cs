...
namespace NesEmu.CPU {
    public static class OpCodeList {
        public static List<OpCode> OpCodes = new List<OpCode> {
            ...
            new OpCode(0x75, "ADC", 2, 4, AddressingMode.ZeroPageX),
            new OpCode(0x6d, "ADC", 3, 4, AddressingMode.Absolute),
            new OpCode(0x7d, "ADC", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteX),
            new OpCode(0x79, "ADC", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteY),
            new OpCode(0x61, "ADC", 2, 6, AddressingMode.IndirectX),
            new OpCode(0x71, "ADC", 2, 5 /*+1 if page crossed*/, AddressingMode.IndirectY),

            new OpCode(0xe9, "SBC", 2, 2, AddressingMode.Immediate),
            new OpCode(0xe5, "SBC", 2, 3, AddressingMode.ZeroPage),
            new OpCode(0xf5, "SBC", 2, 4, AddressingMode.ZeroPageX),
            new OpCode(0xed, "SBC", 3, 4, AddressingMode.Absolute),
            new OpCode(0xfd, "SBC", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteX),
            new OpCode(0xf9, "SBC", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteY),
            new OpCode(0xe1, "SBC", 2, 6, AddressingMode.IndirectX),
            new OpCode(0xf1, "SBC", 2, 5 /*+1 if page crossed*/, AddressingMode.IndirectY),

            new OpCode(0x29, "AND", 2, 2, AddressingMode.Immediate),
            new OpCode(0x25, "AND", 2, 3, AddressingMode.ZeroPage),
            new OpCode(0x35, "AND", 2, 4, AddressingMode.ZeroPageX),
            new OpCode(0x2d, "AND", 3, 4, AddressingMode.Absolute),
            new OpCode(0x3d, "AND", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteX),
            new OpCode(0x39, "AND", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteY),
            new OpCode(0x21, "AND", 2, 6, AddressingMode.IndirectX),
            new OpCode(0x31, "AND", 2, 5 /*+1 if page crossed*/, AddressingMode.IndirectY),

            new OpCode(0x49, "EOR", 2, 2, AddressingMode.Immediate),
            new OpCode(0x45, "EOR", 2, 3, AddressingMode.ZeroPage),
            new OpCode(0x55, "EOR", 2, 4, AddressingMode.ZeroPageX),
            new OpCode(0x4d, "EOR", 3, 4, AddressingMode.Absolute),
            new OpCode(0x5d, "EOR", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteX),
            new OpCode(0x59, "EOR", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteY),
            new OpCode(0x41, "EOR", 2, 6, AddressingMode.IndirectX),
            new OpCode(0x51, "EOR", 2, 5 /*+1 if page crossed*/, AddressingMode.IndirectY),

            new OpCode(0x09, "ORA", 2, 2, AddressingMode.Immediate),
            new OpCode(0x05, "ORA", 2, 3, AddressingMode.ZeroPage),
            new OpCode(0x15, "ORA", 2, 4, AddressingMode.ZeroPageX),
            new OpCode(0x0d, "ORA", 3, 4, AddressingMode.Absolute),
            new OpCode(0x1d, "ORA", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteX),
            new OpCode(0x19, "ORA", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteY),
            new OpCode(0x01, "ORA", 2, 6, AddressingMode.IndirectX),
            new OpCode(0x11, "ORA", 2, 5 /*+1 if page crossed*/, AddressingMode.IndirectY),

            /* Shifts */
            new OpCode(0x0a, "ASL_ACC", 1, 2, AddressingMode.Accumulator),
            new OpCode(0x06, "ASL", 2, 5, AddressingMode.ZeroPage),
            new OpCode(0x16, "ASL", 2, 6, AddressingMode.ZeroPageX),
            new OpCode(0x0e, "ASL", 3, 6, AddressingMode.Absolute),
            new OpCode(0x1e, "ASL", 3, 7, AddressingMode.AbsoluteX),

            new OpCode(0x4a, "LSR_ACC", 1, 2, AddressingMode.Accumulator),
            new OpCode(0x46, "LSR", 2, 5, AddressingMode.ZeroPage),
            new OpCode(0x56, "LSR", 2, 6, AddressingMode.ZeroPageX),
            new OpCode(0x4e, "LSR", 3, 6, AddressingMode.Absolute),
            new OpCode(0x5e, "LSR", 3, 7, AddressingMode.AbsoluteX),

            new OpCode(0x2a, "ROL_ACC", 1, 2, AddressingMode.Accumulator),
            new OpCode(0x26, "ROL", 2, 5, AddressingMode.ZeroPage),
            new OpCode(0x36, "ROL", 2, 6, AddressingMode.ZeroPageX),
            new OpCode(0x2e, "ROL", 3, 6, AddressingMode.Absolute),
            new OpCode(0x3e, "ROL", 3, 7, AddressingMode.AbsoluteX),

            new OpCode(0x6a, "ROR_ACC", 1, 2, AddressingMode.Accumulator),
            new OpCode(0x66, "ROR", 2, 5, AddressingMode.ZeroPage),
            new OpCode(0x76, "ROR", 2, 6, AddressingMode.ZeroPageX),
            new OpCode(0x6e, "ROR", 3, 6, AddressingMode.Absolute),
            new OpCode(0x7e, "ROR", 3, 7, AddressingMode.AbsoluteX),

            new OpCode(0xe6, "INC", 2, 5, AddressingMode.ZeroPage),
            new OpCode(0xf6, "INC", 2, 6, AddressingMode.ZeroPageX),
            new OpCode(0xee, "INC", 3, 6, AddressingMode.Absolute),
            new OpCode(0xfe, "INC", 3, 7, AddressingMode.AbsoluteX),
            ...
            new OpCode(0xd6, "DEC", 2, 6, AddressingMode.ZeroPageX),
            new OpCode(0xce, "DEC", 3, 6, AddressingMode.Absolute),
            new OpCode(0xde, "DEC", 3, 7, AddressingMode.AbsoluteX),
            ...
            new OpCode(0xd5, "CMP", 2, 4, AddressingMode.ZeroPageX),
            new OpCode(0xcd, "CMP", 3, 4, AddressingMode.Absolute),
            new OpCode(0xdd, "CMP", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteX),
            new OpCode(0xd9, "CMP", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteY),
            new OpCode(0xc1, "CMP", 2, 6, AddressingMode.IndirectX),
            new OpCode(0xd1, "CMP", 2, 5 /*+1 if page crossed*/, AddressingMode.IndirectY),
            ...
            new OpCode(0x4c, "JMP", 3, 3, AddressingMode.Absolute), //AddressingMode that acts as Immidiate
            new OpCode(0x6c, "JMP", 3, 5, AddressingMode.Indirect), //AddressingMode:Indirect with 6502 bug

            new OpCode(0x20, "JSR", 3, 6, AddressingMode.Absolute),
            new OpCode(0x60, "RTS", 1, 6, AddressingMode.NoneAddressing),

            new OpCode(0x40, "RTI", 1, 6, AddressingMode.NoneAddressing),

            new OpCode(0xd0, "BNE", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode.Relative),
            new OpCode(0x70, "BVS", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode.Relative),
            new OpCode(0x50, "BVC", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode.Relative),
            new OpCode(0x30, "BMI", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode.Relative),
            new OpCode(0xf0, "BEQ", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode.Relative),
            new OpCode(0xb0, "BCS", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode.Relative),
            new OpCode(0x90, "BCC", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode.Relative),
            new OpCode(0x10, "BPL", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode.Relative),
            ...
            new OpCode(0xb5, "LDA", 2, 4, AddressingMode.ZeroPageX),
            new OpCode(0xad, "LDA", 3, 4, AddressingMode.Absolute),
            new OpCode(0xbd, "LDA", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteX),
            new OpCode(0xb9, "LDA", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteY),
            new OpCode(0xa1, "LDA", 2, 6, AddressingMode.IndirectX),
            new OpCode(0xb1, "LDA", 2, 5 /*+1 if page crossed*/, AddressingMode.IndirectY),

            new OpCode(0xa2, "LDX", 2, 2, AddressingMode.Immediate),
            new OpCode(0xa6, "LDX", 2, 3, AddressingMode.ZeroPage),
            new OpCode(0xb6, "LDX", 2, 4, AddressingMode.ZeroPageY),
            new OpCode(0xae, "LDX", 3, 4, AddressingMode.Absolute),
            new OpCode(0xbe, "LDX", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteY),

            new OpCode(0xa0, "LDY", 2, 2, AddressingMode.Immediate),
            new OpCode(0xa4, "LDY", 2, 3, AddressingMode.ZeroPage),
            new OpCode(0xb4, "LDY", 2, 4, AddressingMode.ZeroPageX),
            new OpCode(0xac, "LDY", 3, 4, AddressingMode.Absolute),
            new OpCode(0xbc, "LDY", 3, 4 /*+1 if page crossed*/, AddressingMode.AbsoluteX),


            new OpCode(0x85, "STA", 2, 3, AddressingMode.ZeroPage),
            new OpCode(0x95, "STA", 2, 4, AddressingMode.ZeroPageX),
            new OpCode(0x8d, "STA", 3, 4, AddressingMode.Absolute),
            new OpCode(0x9d, "STA", 3, 5, AddressingMode.AbsoluteX),
            new OpCode(0x99, "STA", 3, 5, AddressingMode.AbsoluteY),
            new OpCode(0x81, "STA", 2, 6, AddressingMode.IndirectX),
            new OpCode(0x91, "STA", 2, 6, AddressingMode.IndirectY),

            new OpCode(0x86, "STX", 2, 3, AddressingMode.ZeroPage),
            new OpCode(0x96, "STX", 2, 4, AddressingMode.ZeroPageY),
            new OpCode(0x8e, "STX", 3, 4, AddressingMode.Absolute),

            new OpCode(0x84, "STY", 2, 3, AddressingMode.ZeroPage),
            new OpCode(0x94, "STY", 2, 4, AddressingMode.ZeroPageX),
            ...
            /* Illegal Ricoh instructions */
            new OpCode(0x0b, "AAC", 2, 2,  AddressingMode.Immediate),
            new OpCode(0x2b, "AAC", 2, 2,  AddressingMode.Immediate),
            ...
            new OpCode(0x4b, "ASR", 2, 2,  AddressingMode.Immediate),

            new OpCode(0xab, "ATX", 2, 2,  AddressingMode.Immediate),

            new OpCode(0x9f, "AXA", 3, 5,  AddressingMode.AbsoluteY),
            new OpCode(0x93, "AXA", 2, 6,  AddressingMode.IndirectY),
            ...
            new OpCode(0x02, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0x12, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0x22, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0x32, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0x42, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0x52, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0x62, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0x72, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0x92, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0xb2, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0xd2, "KIL", 1, 0,  AddressingMode.NoneAddressing),
            new OpCode(0xf2, "KIL", 1, 0,  AddressingMode.NoneAddressing),

            new OpCode(0xbb, "LAR", 3, 4,  AddressingMode.AbsoluteY),
            ...
            new OpCode(0x9e, "SXA", 3, 5,  AddressingMode.AbsoluteY),

            new OpCode(0x9c, "SYA", 3, 5,  AddressingMode.AbsoluteX),

            new OpCode(0x0c, "*NOP", 3, 4,  AddressingMode.Absolute),
            new OpCode(0x1c, "*NOP", 3, 4,  AddressingMode.AbsoluteX),
            new OpCode(0x3c, "*NOP", 3, 4,  AddressingMode.AbsoluteX),
            new OpCode(0x5c, "*NOP", 3, 4,  AddressingMode.AbsoluteX),
            new OpCode(0x7c, "*NOP", 3, 4,  AddressingMode.AbsoluteX),
            new OpCode(0xdc, "*NOP", 3, 4,  AddressingMode.AbsoluteX),
            new OpCode(0xfc, "*NOP", 3, 4,  AddressingMode.AbsoluteX),

            // Skipping this for now since it's unstable
            //new OpCode(0x8b, "XAA", 2, 2,  AddressingMode.Immediate),

            new OpCode(0x9b, "XAS", 3, 5,  AddressingMode.AbsoluteY),
        };
    }
}
